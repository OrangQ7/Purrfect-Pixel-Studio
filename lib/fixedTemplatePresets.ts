...
export const FIXED_TEMPLATE_PRESETS: Record<FixedTemplateId, FixedTemplatePreset> = {
  white_cat: {
    id: "white_cat",
    label: "White cat",
    description: "All white, with pink inner ears and paw pads.",
    regionRoles: {
      BG: "bg",
      OL: "outline",
      LE: "furWhite",
  ...
  siamese_point: {
    id: "siamese_point",
    label: "Siamese point",
    description: "Cream body with darker ears, face mask, tail, and paws.",
    regionRoles: {
      BG: "bg",
      OL: "outline",
      LE: "furWarmCream",
  ...
  ragdoll_bicolor: {
    ...
    description: "White center blaze, warm brown side patches, light body, and brown tail.",
    regionRoles: {
      BG: "bg",
      OL: "outline",
      LE: "furWarmCream",
  ...
  cow_cat: {
    id: "cow_cat",
    label: "Cow cat",
    description: "Large dark areas with a white face center, chest, belly, and grey tail tip.",
    regionRoles: {
      BG: "bg",
      OL: "outline",
      LE: "furBrownDark",
  ...
  blue_golden_shaded: {
    ...
    description: "Warm golden body with taupe shading on the top, sides, and tail.",
    regionRoles: {
      BG: "bg",
      OL: "outline",
      LE: "furGolden",
  ...
  solid_blue: {
    id: "solid_blue",
    label: "Blue cat",
    description: "A blue-grey body with slightly darker edges and tail.",
    regionRoles: {
      BG: "bg",
      OL: "outline",
      LE: "furBlue",
